...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    self.viewController.checkAmount.text = nil;
    self.viewController.tipPercent.text = nil;
    self.viewController.people.text = @"1";
    [self.viewController updateTipTotals];
    //method calling syntax: bracket, object you are calling it on, method name, close bracket
}
